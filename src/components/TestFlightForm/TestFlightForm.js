            ...
            <Card>
                <CardBody>
                    ...
                    <Form>
                        ...
                        <InputGroup>
                            <InputGroupAddon addonType="prepend">$</InputGroupAddon>
                            <Input type="text"  onChange={this.handleInputChange} name="budget" id="budget" placeholder="What is your budget?" />
                        </InputGroup>
                        <br />
                    </Form>
                    <br />
                    <Button onClick={this.onSubmit}>Submit</Button>
                    <Alert isOpen={this.state.showSuccess} color="success">Your data was submitted successfully! Your test flight awaits!</Alert>
